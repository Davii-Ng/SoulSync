...
core_companion_agent = Agent(
    ...
    instruction=(
        ...
        "Use 'analyze_emotion' to understand what they're really going through, then 'suggest_resource' with the emotion AND severity "
        "from the analysis result to get the right response for their intensity level.\n\n"
        ...
        "Pay attention to the confidence score: if it's below 0.5, ask a clarifying question before assuming you know how they feel. "
        "'I want to make sure I'm reading this right — are you feeling more X or Y?'\n\n"
